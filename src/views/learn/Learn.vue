    ...
    <div class="main">
      <div class="main-left">
        ...
        <div class="left-main">
          ...
          <div class="left-title">
            <img src="../../assets/icons/memory.png" />
            学习模式
          </div>
          <!-- 左侧统计栏 -->
          <div class="left-counter">
            ...
            <div class="left-number" style="color: #eacd76">
              {{ wordReview }}
            </div>
            <span>需巩固</span>
            <img src="../../assets/icons/next.png" />
            <div class="left-number" style="color: #23b26d">
              {{ wordFinished }}
            </div>
            <span>已完成</span>
          </div>
      ...
      <div class="learn-word">
        ...
        <div class="word-card" @click="cardClicked">
          ...
          <div class="word-zh" :style="showZh ? '' : 'opacity:0'">
            {{ wordZh }}
          </div>
        </div>
