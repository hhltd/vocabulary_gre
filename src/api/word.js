...
import list1 from '../assets/words/List1.json'
import list2 from '../assets/words/List2.json'
import list3 from '../assets/words/List3.json'
import list4 from '../assets/words/List4.json'
import list5 from '../assets/words/List5.json'
import list6 from '../assets/words/List6.json'

//该api主要包括两部分 一部分为学习模式 一部分为复习模式
